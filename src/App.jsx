...
const AppContent = () => {
  ...
  return (
    <div className="max-w-[100vw] min-h-screen flex flex-col pt-16 relative [&>*:last-child]:mt-auto">
      <Navbar />
      {location.pathname === '/' && (
        <>
        <div className="min-h-screen flex-1 flex flex-col justify-center items-center py-8 text-8xl">
